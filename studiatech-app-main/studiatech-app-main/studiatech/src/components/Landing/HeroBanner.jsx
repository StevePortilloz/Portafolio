        ...
        <div className="flex align-middle">
          <div className="relative">
            ...
            <input
              ...
              placeholder={`Intenta "Como sacar 100 con Godoy"`}
              value={searchData}
        ...
        <div className="text-white flex gap-4">
          ...
          <ul className="flex gap-5">
            <li
              ...
              onClick={() => router.push("/search?q=Diseño Web")}
            >
              Diseño Web
            </li>
            <li
              className="text-sm py-1 px-3 border rounded-full hover:bg-white hover:text-black transition-all duration-300	cursor-pointer"
              onClick={() => router.push("/search?q=Calculo")}
            >
              Calculo
            </li>
            <li
              className="text-sm py-1 px-3 border rounded-full hover:bg-white hover:text-black transition-all duration-300	cursor-pointer"
              onClick={() => router.push("/search?q=Ing de Software")}
            >
              Ing. de Software
            </li>
            <li
              className="text-sm py-1 px-3 border rounded-full hover:bg-white hover:text-black transition-all duration-300	cursor-pointer"
              onClick={() => router.push("/search?q=Musica")}
            >
              Musica
            </li>
          </ul>
