        ...
        <div className="flex min-h-[80vh] my-10 mt-0 px-32 gap-5">
          ...
          <div>
            <div className="grid grid-cols-3 gap-10 w-full">
              ...
              >
                <h2 className="text-xl">Total de servicios</h2>
              ...
              >
                <h2 className="text-xl">Total de ordenes</h2>
                <h3 className="text-[#1DBF73] text-3xl font-extrabold">
              ...
              >
                <h2 className="text-xl"> Mensajes sin leer</h2>
                <h3 className="text-[#1DBF73] text-3xl font-extrabold">
              ...
              <div className="shadow-md h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300">
                <h2 className="text-xl">Ingreso del dia</h2>
                <h3 className="text-[#1DBF73] text-3xl font-extrabold">
                  ${dashboardData?.dailyRevenue}
                </h3>
              </div>
              <div className="shadow-md h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300">
                <h2 className="text-xl">Ingreso Mensual</h2>
                <h3 className="text-[#1DBF73] text-3xl font-extrabold">
                  ${dashboardData?.monthlyRevenue}
                </h3>
              </div>
              <div className="shadow-md h-max p-10 flex flex-col gap-2 cursor-pointer hover:shadow-xl transition-all duration-300">
                <h2 className="text-xl">Ingreso Anual</h2>
                <h3 className="text-[#1DBF73] text-3xl font-extrabold">
